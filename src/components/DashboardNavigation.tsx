  ...
  return (
    <div className={styles.dashboardNavigation}>
      ...
      <div className={styles.accountLinks}>
        ...
        />
        <div className={styles.dashboard}>Log-out</div>
      </div>
      <div className={styles.accountLinks1}>
        ...
        />
        <div className={styles.dashboard1}>Settings</div>
      </div>
      <div className={styles.accountLinks2}>
        ...
        />
        <div className={styles.dashboard2}>Shopping Cart</div>
      </div>
      ...
      <div className={styles.accountLinks4}>
        ...
        />
        <div className={styles.dashboard4}>Order History</div>
      </div>
      <div className={styles.accountLinks5}>
        <img className={styles.dashboard2Icon5} alt="" src="/dashboard-2.svg" />
